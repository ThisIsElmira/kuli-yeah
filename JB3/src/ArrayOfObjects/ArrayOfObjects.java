...
//        System.out.println("Second rectangle, width: " + rectangleArray[0].width + ", length: " + rectangleArray[0].length);
//        System.out.println("Third rectangle, width: " + rectangleArray[0].width + ", length: " + rectangleArray[0].length);
    }
}
